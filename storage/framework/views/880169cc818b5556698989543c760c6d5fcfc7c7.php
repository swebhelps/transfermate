          ...
          <div class="card mb-4">
            <div class="card-body px-0 pt-0 pb-2" id="main_card_box" style="height: 265px;">
              ...
              <script>
                ...
                {
                    <?php if(isset($enable_table)): ?>
                      window.enable_table = "<?php echo e($enable_table); ?>";
                    <?php endif; ?>
                ...
                function search(author_name) 
                {
                    ...
                    .then((e) => updatetable(e));*/
                     ...
                     // var token = $("input[name='_token']").val();
                      ...
                      $.ajax({
                        url: "<?php echo e(route('getAuthor')); ?>",
                        type: 'POST',
                        async: true,
                        data: {
...
<?php /**PATH C:\Apache24\htdocs\blog\resources\views/searchUser.blade.php ENDPATH**/ ?>