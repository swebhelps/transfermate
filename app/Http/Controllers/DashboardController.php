...
class DashboardController extends Controller
{
            ...
            if(isset($api_array_data['book']))
            {
                foreach($api_array_data['book'] as $key=>$loop_value)
                {
                        ...
                        if($author_check_exists !=NULL && $book_check_exists !=NULL) 
                        {
                            ...
                            $author_id = $author_check_exists->author_id;
                            ...
                            Book::where(['author_id'=>$author_id,'book_id'=>$book_id])->update(['book_name'=>$book_name]);
                            $flag_insert=3;
    ...
    public function show(Request $request)
    {
        ...
        $procedure = "getAuthorDetails()";
        $book_list = self::callMasterProcedure($procedure);
        return view('searchUser', array('enable_table'=>$enable_table));
    }
    ...
    function getAuthor()
    {
        ...
        if(isset($book_list))
        {
            ...
            return Response::json(['errors' => ['Please select checkbox to conﬁrm.']],422);
        }
    }
